...
<head>
  ...
  <link href=" {{ asset('public/admin/include/fontawesome-free/css/all.min.css') }} " rel="stylesheet" type="text/css">
           ...
           <!--  <li class="nav-item dropdown no-arrow d-sm-none">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">@yield('user-name')</span>
                <img class="img-profile rounded-circle" src="@yield('src-img')">
              </a> 
